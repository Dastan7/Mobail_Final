...
class _DetailScreenState extends State<DetailScreen> {
  ...
  buildGuitarShowcase(BuildContext context) {
    return Stack(
      children: [
        Container(
          width: MediaQuery.of(context).size.width,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "For the convenience of buyers, an online store was created, which presents a wide range of high-quality musical instruments, accessories and sound equipment for both professionals and beginners in various price categories from budget products to elite ones.",
              style: TextStyle(
                fontSize: 18,
                color: DefaultElements.kprimarycolor,
              ),
